            ...
            <div class="row mb-20">
              <div class="conbox">
                  ...
                  <div class="select-frame">
                    <div class="select-wrap sel-s-1">
                      <button type="button" class="btn-select">
                        <span class="UpDe">증가율</span><span class="InDe">건수</span>
                        <img
                      ...
                      <ul class="option__list" >
                        <li class="option__list-item">
                          <button type="button" id="gunsu">건수</button>
                        </li>
                        <li class="option__list-item">
                          <button type="button" id="upt">증가율</button>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="conbox__content">
	                <c:forEach var="InDe" items="${InDe}">
		                <div class="hbonut InDe" id="InDe">
			                <canvas id="${InDe.infdnm}" width="200" height="100"></canvas>
			                <p class="gs">관심</p>
			               	<p class="jy">주의</p>
			               	<p class="gg">경계</p>
			               	<p class="sg">심각</p>
			               	<img alt="" src="/resources/img/NS.png" class="ns" id="${InDe.infdisnm}">
			               	<p class="bm">${InDe.infdisnm}</p>
		                </div>
	                </c:forEach>
  	                <c:forEach var="UpDe" items="${UpDe}">
		                <div class="hbonut UpDe" id="UpDe">
			                <canvas id="${UpDe.infdnm}" width="200" height="100"></canvas>
			                <p class="gs">관심</p>
			               	<p class="jy">주의</p>
			               	<p class="gg">경계</p>
			               	<p class="sg">심각</p>
			               	<img alt="" src="/resources/img/NS.png" class="ns" id="${UpDe.infdisnm}">
			               	<p class="bm">${UpDe.infdisnm}</p>
		                </div>
	                </c:forEach>
                </div>
              </div>
                ...
                <div class="conbox">
                  ...
                  <script type="text/javascript">
                	...
                	<c:forEach var="InDe" items="${InDe}">
                	 ...
                	 if(${InDe.total}>=50){
		            		$('#InDe #${InDe.infdisnm}').css("transform", "rotate(70deg)").css("transition","all ease 1s")
		            	} 
		              	else if(${InDe.total}>=30){
		             		$('#InDe #${InDe.infdisnm}').css("transform", "rotate(35deg)").css("transition","all ease 1s")
		             	}
		              	else if(${InDe.total}>=10){
		             		$('#InDe #${InDe.infdisnm}').css("transform", "rotate(-35deg)").css("transition","all ease 1s")
		             	}
		              	else if(${InDe.total}<10){
		             		$('#InDe #${InDe.infdisnm}').css("transform", "rotate(-70deg)").css("transition","all ease 1s")
	                ...
	                new Chart(document.getElementById("${InDe.infdnm}"), {
                	    type: 'doughnut',
                	    data: {
                	      labels: ["관심", "주의", "경계", "심각"],
                	      datasets: [
                	        {
                	          label: "위기경보",
                	          backgroundColor: ["#0000FF", "rgb(245,245,0)","rgb(255,128,0)","rgb(255,0,0)"],
                	          borderWidth: 0,
					...
					<c:forEach var="UpDe" items="${UpDe}">
                	 ...
                	 if(${UpDe.total}>=50){
		            		$('#UpDe #${UpDe.infdisnm}').css("transform", "rotate(70deg)").css("transition","all ease 1s")
		            	} 
		              	else if(${UpDe.total}>=30){
		             		$('#UpDe #${UpDe.infdisnm}').css("transform", "rotate(35deg)").css("transition","all ease 1s")
		             	}
		              	else if(${UpDe.total}>=10){
		             		$('#UpDe #${UpDe.infdisnm}').css("transform", "rotate(-35deg)").css("transition","all ease 1s")
		             	}
		              	else if(${UpDe.total}<10){
		             		$('#UpDe #${UpDe.infdisnm}').css("transform", "rotate(-70deg)").css("transition","all ease 1s")
                	 ...
                	 new Chart(document.getElementById("${UpDe.infdnm}"), {
                 	    type: 'doughnut',
                 	    data: {
                 	      labels: ["관심", "주의", "경계", "심각"],
                 	      datasets: [
                	    ...
                	    <script type="text/javascript">
					        	...
					        	$('#gunsu').on("click", function(){
					        		$(".InDe").css("display", "inline-block");
					        		$(".UpDe").css("display", "none");
					        	});
					        	$('#upt').on("click", function(){
					        		$(".InDe").css("display", "none");
					        		$(".UpDe").css("display", "inline-block");
					        	});
